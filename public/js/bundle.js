...
var review = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(_review, rating, tourID) {
    var res;
...
var stripe = Stripe('pk_test_vcp7StEKXgUa66V4AokjXgxz00TpZwqb0a');
...
if (reviewForm) reviewForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var des = document.getElementById('review').value;
  var rating = document.getElementById('rating').value;
  var tourID = document.getElementById('tour').value;
  (0, _review.review)(des, rating, tourID);
});
